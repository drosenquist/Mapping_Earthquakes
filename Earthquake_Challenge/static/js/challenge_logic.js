...
d3.json('https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/4.5_week.geojson').then(function(data) {
  ...
  function styleInfo2(feature) {
    return {
      opacity: 1,
      fillOpacity: 1,
      fillColor: Color2(feature.properties.mag),
      color: "#000000",
      radius: Radius2(feature.properties.mag),
      stroke: true,
      weight: 0.5
    };
  }
